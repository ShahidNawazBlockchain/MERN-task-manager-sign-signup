...
const fetchData = async () => {
  try {
    const response = await axios.get("https://mern-task-manager-sign-signup-3eefgxkfi-shahid-nawazs-projects.vercel.app/api/v2/gettask");
...
const App = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (formData.id) {
        // Update task
        await axios.put(
          `https://mern-task-manager-sign-signup-3eefgxkfi-shahid-nawazs-projects.vercel.app/api/v2/update/${formData.id}`,
          formData
        );
        setSuccessMessage("Task updated successfully");
      } else {
        // Add new task
        await axios.post("https://mern-task-manager-sign-signup-3eefgxkfi-shahid-nawazs-projects.vercel.app/api/v2/addtask", formData);
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://mern-task-manager-sign-signup-3eefgxkfi-shahid-nawazs-projects.vercel.app/api/v2/delete/${id}`);
